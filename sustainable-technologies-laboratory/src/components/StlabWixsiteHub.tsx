        ...
        {(() => {
          const journalsList = OTHER_PUBLICATIONS.filter(pub => {
            ...
            return !(
              ...
              c.includes("indian knowledge systems") ||
              c.includes("elsevier") ||
              c.includes("handbook") ||
                          ...
                          {pub.doi && (
                            <div className="flex flex-wrap gap-2 pt-1 items-center">
                              <a
                                ...
                                rel="noreferrer"
                                referrerPolicy="no-referrer"
                                className="text-[10px] bg-slate-100 hover:bg-slate-200 border border-slate-200 rounded px-1.5 py-0.5 font-mono text-slate-500 hover:text-slate-700 transition-colors"
                              >
                                DOI: {pub.doi}
                              </a>
                            </div>
              ...
              <div className="bg-white border border-slate-200 hover:border-st-green/30 rounded-xl p-5 hover:shadow-md transition-all duration-300 card-3d-bevel">
                <div className="space-y-3">
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      <h4 className="text-sm font-extrabold text-[#0d56a6] uppercase tracking-wide">5. Bioprocess Engineering and Technology</h4>
              ...
              <div className="bg-white border border-slate-200 hover:border-st-orange/30 rounded-xl p-5 hover:shadow-md transition-all duration-300 card-3d-bevel">
                <div className="space-y-3">
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      <h4 className="text-sm font-extrabold text-[#0d56a6] uppercase tracking-wide">7. Transport Phenomena</h4>
              ...
              <div className="bg-white border border-slate-200 hover:border-st-blue/30 rounded-xl p-5 hover:shadow-md transition-all duration-300 card-3d-bevel">
                <div className="space-y-3">
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      <h4 className="text-sm font-extrabold text-[#0d56a6] uppercase tracking-wide">8. Engineered Systems Analysis</h4>
                      <p className="text-[10px] text-slate-400 font-mono">IIT Indore / BSBE Department</p>
                    </div>
                  </div>
                  <p className="text-slate-600 text-xs leading-relaxed font-sans">
              ...
              <div className="bg-white border border-slate-200 hover:border-st-green/30 rounded-xl p-5 hover:shadow-md transition-all duration-300 card-3d-bevel">
                <div className="space-y-3">
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      <h4 className="text-sm font-extrabold text-[#0d56a6] uppercase tracking-wide">9. Modeling and Controls in Medical Devices</h4>
                      <p className="text-[10px] text-slate-400 font-mono">IIT Indore / BSBE Department</p>
                    </div>
                  </div>
                  <p className="text-slate-600 text-xs leading-relaxed font-sans">
