...
export const OTHER_PUBLICATIONS: Publication[] = [
  ...
  {
    citation: "Murthy, G. S., Gnansounou, E., Khanal, S. K., Pandey, A. (2022). Biomass, biofuels, biochemicals: green-economy: systems analysis for sustainability. Elsevier.",
    year: 2022
  },
  {
    citation: "Indian Knowledge Systems, Indian contributions to Sciences, Volume-1",
    year: 2026,
    link: "https://bharatiya-jnana-sarita.info/published_books/68e781d3ed96123eb8e43269"
  },
  {
  ...
  {
    citation: "Tabatabaie, S. M. H., Tahami, H., Murthy, G. S. (2018). A regional life cycle assessment and economic analysis of camelina biodiesel production in the Pacific Northwestern US. Journal of Cleaner Production 172, 2389-2400.",
    year: 2018
  },
  {
